...
Write all prose in {{ language }}. Technical terms, proper nouns, file paths, agent names, and LaTeX may remain in their original language.
...
2. `{{ runtime.research_tree_file }}` for file roles and authority boundaries
3. `research/focus.md`
