...
- Write all prose in {{ language }} **except** when copying verbatim from the input file — the input is already in the correct language, as PI wrote it. Your own messages (error strings, commit-amend notes) follow the language rule
