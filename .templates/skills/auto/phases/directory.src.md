...
File formats (note.md, map.md, plan.md, backlog.md, state.md) are defined in `{{ runtime.research_tree_file }}`. This section covers only files specific to `/auto` operations.
