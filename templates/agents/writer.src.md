...
1. `.claude/common.md`
2. `plan.md` (Story Arc with item tree — understand where the section fits in the overall story)
3. Relevant `items/*.md` files (check kind, status, and context of related items)
