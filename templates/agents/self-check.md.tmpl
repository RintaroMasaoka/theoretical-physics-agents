...
**This agent intentionally has no research context.** It does not read plan.md, items/, notes/, or any other research files. The document's authors know the full context and thus easily miss undefined terms or terminology confusion — but a reader without context will immediately stumble on them. Providing that perspective is this agent's raison d'être.
