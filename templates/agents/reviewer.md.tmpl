...
1. `.claude/common.md`
2. `plan.md` (check the item tree — kind and status of related items)
3. Relevant `items/*.md` files (for items referenced in the section)
...
**A. Item Consistency**: Do descriptions in the section match the status and kind of items in the plan.md tree and items/ files? Are non-stable items written as established results? Is the writing format appropriate for the kind (e.g., stable conjecture should have a proof, observation should be presented as a remark)?
