...
1. **Research-memory shape scan** — inspect whether node identities, parent-child roles, status, archive placement, and surface routes still match `.claude/research-tree.md` § Research-Memory Shape. Execute clear split / reframe / reparent / close / archive / parent-plan updates before treating the same pressure as prose cleanup.
