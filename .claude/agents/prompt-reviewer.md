...
Only the target file provided by PI. **Do not read any other files** -- the reviewer's value comes from having no prior context. Reading research/focus.md, research/ tree, notes/, etc. would give you the same bias the fixer already has.
