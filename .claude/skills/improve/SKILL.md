...
| **Generated (do not edit)** | `.claude/agents/*.md`, `.claude/skills/*/SKILL.md`, `.claude/CLAUDE.md`, `.claude/common.md` | Overwritten by `generate-runtime.mjs` |
...
**Reflect and confirm.** Apply valid blind-review findings and fit-check findings, then re-run `generate-runtime.mjs` if changes were made. Then present the final change to the user via AskUserQuestion for approval.
