...
note.md is the draft fact layer — canonical rule in `.claude/research-tree.md` § note.md. It is not current state, not a report index, and not final manuscript authority.
