...
File formats (note.md, map.md, plan.md, backlog.md, state.md) are defined in `.claude/research-tree.md`. This section covers only files specific to `/auto` operations.
