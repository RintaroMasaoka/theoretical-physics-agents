...
|---|---|---|
| `.codex/skills/auto/phases/dispatch.md` | After the Steering Gate, when launching workers and critic | Pattern A / B launch methods, prompt template, Provisional Artifact Review, Durable Surface Review, per-agent dynamic data |
