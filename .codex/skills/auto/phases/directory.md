...
research/                 # Research tree — draft facts, state, strategy, graph
  ...
  map.md                  #   Root: optional child/context routing map
  ...
  {Branch Name}/          #   Research direction (Title Case with spaces)
    ...
    map.md                #     (optional) Parent-level map of direct children and reopen conditions
    ...
    report_{slug}.md      #     (optional) Clean analysis artifact (format: see .codex/research-tree.md)
...
File formats (note.md, map.md, plan.md, backlog.md, state.md) are defined in `.codex/research-tree.md`. This section covers only files specific to `/auto` operations.
