...
|---|---|---|---|
| `note.md` | Draft facts | Overwrite | **Fact layer.** Established claims, definitions, derivations or derivation skeletons, scope, limitations, and source/project boundaries. Lower authority than `manuscript/`; no workflow state. Canonical spec: `.codex/research-tree.md` § note.md |
