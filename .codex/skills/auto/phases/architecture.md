...
Every node is a **folder**. File formats are defined in `.codex/research-tree.md` (the canonical reference). Key points for research planner:
...
|---|---|---|---|
| `findings.md` | Draft facts | Overwrite | **Fact layer.** Established claims, definitions, derivations or derivation skeletons, scope, limitations, and source/project boundaries. Lower authority than `manuscript/`; no workflow state. Canonical spec: `.codex/research-tree.md` § findings.md |
| `guide.md` | Human oversight | Overwrite | **Human entrypoint.** Orientation, reading path, verification map, suspicious points, and oversight questions. Not fact authority. Canonical spec: `.codex/research-tree.md` § guide.md |
...
findings.md creation, retraction, format, and ownership are defined canonically in `.codex/research-tree.md`.
