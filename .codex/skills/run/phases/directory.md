...
research/                 # Research tree — the single knowledge structure
  ...
  {Branch Name}/          #   Research direction (Title Case with spaces)
    ...
    report_{slug}.md      #     (optional) PI-verified report (format: see .codex/research-tree.md)
...
File formats (note.md, plan.md, .log.md) are defined in `.codex/research-tree.md`. This section covers only files specific to `/run` operations.
