...
1. `.codex/common.md`
2. `.codex/research-tree.md` — the canonical spec for file roles, findings.md rules, provenance taxonomy
3. `.codex/notes-syntax.md`
4. `.codex/research-tree.md` § Folder Names / naming rules — revisit when your focus text, child names, worker dispatches, or tree directives give a short expression handle shape: repeated shorthand, child/focus label, dispatch handle, tree-directive term, or reuse of an unlicensed phrase from earlier context
...
### Naming Decisions
- {only when this focus, a child name, a worker dispatch, or a tree directive gives a short expression handle shape or reuses an unlicensed earlier phrase as a handle; use `.codex/research-tree.md` naming rules}
- (may be empty)
