...
4. `.codex/naming.md` — reusable-name routing contract
...
- `concepts/{term}.md` — create or update when closing a reusable-name routing transaction per `.codex/naming.md`; update on definition drift
...
Canonical rationale: `.codex/naming.md`.
...
2. If creating or updating a concept note, include reuse-license front matter from `.codex/naming.md`: expansion, grounding, stability, carry scope, claim permission, merge boundary, and reader action. Keep the body short and explanatory.
